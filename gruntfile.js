...
module.exports = function( grunt ) {
  grunt.initConfig( {
    ...
    sass: {
      min: {
        files: {
          "dist/react-date-pick.css": "src/stylesheets/datepicker.scss"
        },
        options: {
          sourcemap: "none",
          style: "expanded"
      ...
      unmin: {
        files: {
          "dist/react-date-pick.min.css": "src/stylesheets/datepicker.scss"
        },
        options: {
          sourcemap: "none",
          style: "compressed"
    ...
    webpack: {
      unmin: mergeWebpackConfig( {
        output: {
          filename: "react-date-pick.js"
        }
      } ),
      min: mergeWebpackConfig( {
        output: {
          filename: "react-date-pick.min.js"
        },
        plugins: [
